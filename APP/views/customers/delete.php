<!doctype html>
  ...
  <div class="wrapper">
        ...
        <?php include $_SERVER['DOCUMENT_ROOT']."/".PROJECT."/app/views/includes/navbar.php"?>
              ...
              <div class="container-fluid ">
                    ...
                    <div class="invoi invoi-blue">
                        <div class="row">
                          <div class="col-sm-8">
                               <h5 class ="text-blanco"><i class="fas fa-sitemap"></i> Eliminar Cliente</h5>
                            </div>
                        </div>
                    </div>
                              ...
                              <div class="row">
                                      ...
                                      <div class="col-md-6 col-sm-12 col-12 ">
                                        <div class = "alert alert-warning">
                                            <b>¿Desea eliminar el cliente?</b> No es posible revertir
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                            <input type="tel" class="form-control form-control-sm" value='<?php echo $item->TELEFONO; ?>' readonly id="telefono" name="telefono" placeholder="Ingrese teléfono">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                            <input type="tel" class="form-control form-control-sm" value='<?php echo $item->CELULAR; ?>' readonly id="celular" name="celular" placeholder="Ingrese celular">
                                            </div>
                                        </div>
                                      </div>
    ...
    <script src ="<?php echo PATH; ?>js/customers/delete.js?v=<?php echo(rand()); ?>"></script>
</body>
</html>

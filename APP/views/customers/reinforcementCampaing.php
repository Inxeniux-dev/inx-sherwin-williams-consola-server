<!doctype html>
  ...
  <div class="wrapper">
        ...
        <?php include $_SERVER['DOCUMENT_ROOT']."/".PROJECT."/app/views/includes/navbar.php"?>
              ...
              <div class="container-fluid ">
                    ...
                    <div class="invoi  invoi-blue">
                        <div class="row">
                          <div class="col-sm-12">
                               <h5 class ="text-blanco">Cargar Archivo de Campaña de Refuerzo</h5>
                            </div>
                        </div>
                    </div>
                          ...
                          <div class="row">
                            <div class="col-sm-12">
                                <div class = "alert alert-info">
                                     <b>Este proceso no es reversible, verifique bien la información a cargar</b>
                                </div>
                            </div>
                          </div>
                       </div>
                       ...
                       <div class="invoi  invoi-blue">
                           <div class="row">
                             <div class="col-sm-12" style="text-align:center;">
                                         ...
                                         <img src="<?php echo PATH; ?>/img/excel_campaing_reforcement.jpg" width="85%"/>
                                         <br><br><br>
                               </div>
                           </div>
                       </div>
    ...
    <script src ="<?php echo PATH; ?>js/items/reinforcement_campaing.js?v=<?php echo(rand()); ?>"></script>
</body>
</html>

<!doctype html>
  ...
  <div class="wrapper">
        ...
        <?php include $_SERVER['DOCUMENT_ROOT']."/".PROJECT."/app/views/includes/navbar.php"?>
              ...
              <div class="container-fluid ">
                    <div class="row">
                        <div class="invoi invoi-blue" style ="margin-bottom: 1px;">
                                <div class="row">
                                    <div class="col-sm-8 col-12 ">
                                        <div class="form-row">
                                            <div class="col">
                                                <input type="text" class="form-control form-control-sm" id="search" name="search" placeholder="Buscar Sucursales" />
                                            </div>
                                            <div class="col">
                        ...
                        <div class="invoi">
                                <div class="table-responsive table-locations" style='min-height: 200px;'>
                                </div>
                         </div>
    ...
    <script src ="<?php echo PATH; ?>js/locations/list.js"></script>
</body>
</html>

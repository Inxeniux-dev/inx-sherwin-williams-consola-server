<!doctype html>
  ...
  <div class="wrapper">
        ...
        <?php include $_SERVER['DOCUMENT_ROOT']."/".PROJECT."/app/views/includes/navbar.php"?>
              ...
              <div class="container-fluid ">
                    ...
                    <div class="invoi">
                        <div class="row">
                          <div class="col-sm-8">
                               <h5 class ="text-primary">Historial de Ventas Acumuladas por Cliente</h5>
                            </div>
                                        ...
                                        <div class="table-responsive  mt-3">
                                                <table class="table  table-sm">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-blanco spacing t-client" align = "right"><b>Todos los clientes</b></td>
                                                    </tr>
                                                </table>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="table-responsive  mt-3">
                                                <table class="table  table-sm">
                                                    <tbody>
                                                    <tr>
                                                        <td class="text-blanco spacing">Buscar Cliente:</td>
    ...
    <script src ="<?php echo PATH; ?>js/reports/sales_by_client_acum.js"></script>

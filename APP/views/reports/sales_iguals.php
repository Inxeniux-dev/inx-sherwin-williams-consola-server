<!doctype html>
  ...
  <div class="wrapper">
        ...
        <?php include $_SERVER['DOCUMENT_ROOT']."/".PROJECT."/app/views/includes/navbar.php"?>
              ...
              <div class="container-fluid ">
                    ...
                    <div class="invoi">
                        <div class="row">
                          <div class="col-sm-8">
                               <h5 class ="text-primary">Historial de Igualados</h5>
                            </div>
                        ...
                        <div class="invoi">
                          <div class="table-responsive table-iguals" style='min-height: 50px;'>
    ...
    <script src ="<?php echo PATH; ?>js/reports/iguals.js"></script>

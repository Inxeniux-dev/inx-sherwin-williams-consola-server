<!doctype html>
  ...
  <div class="wrapper">
              ...
              <div class="container-fluid ">
                    <div class="row">
                                          <div class="invoi">
                                              <div class="row">
                                                <div class="col-sm-8">
                                                     <h5 class ="text-primary"><b><i class="fas fa-arrows-alt-h"></i> Historial de Entradas y Salidas </b></h5>
                                                  </div>
    ...
    <?php include $_SERVER['DOCUMENT_ROOT']."/".PROJECT."/app/views/includes/scripts.php"?>
      ...
      <script src ="<?php echo PATH; ?>js/reports/entradas_y_salidas.js"></script>

<!doctype html>
  <head>
    ...
    <title>Crear Producto Canje</title>
  </head>
  <body>
        ...
        <?php include $_SERVER['DOCUMENT_ROOT']."/".PROJECT."/app/views/includes/navbar.php"?>
              ...
              <div class="container-fluid ">
                    ...
                    <div class="invoi invoi-blue">
                        <div class="row">
                          <div class="col-sm-8">
                               <h5 class ="text-blanco"><i class="fas fa-gift"></i> Crear Producto para canje de puntos</h5>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-12" style ="margin-bottom:20px;">
                                      ...
                                      <div class="col-md-6 col-sm-12 col-12 ">
                                          <div class="form-group row">
                                              ...
                                              <div class="col-sm-8">
                                              <input type="text" class="form-control form-control-sm" value='' id="producto" name="producto" placeholder="Ingrese producto">
                                              </div>
                                          </div>
                                          ...
                                          <div class="form-group row">
                                              ...
                                              <div class="col-sm-8">
                                              <input type="text" class="form-control form-control-sm" value='' id="cantidad" name="cantidad" placeholder="Ingrese producto">
                                              </div>
                                          </div>
                                          ...
                                          <div class="form-group row">
                                              ...
                                              <div class="col-sm-8">
                                              <input type="text" class="form-control form-control-sm" value='' id="precio" name="precio" placeholder="Ingrese precio">
                                              </div>
                                          </div>

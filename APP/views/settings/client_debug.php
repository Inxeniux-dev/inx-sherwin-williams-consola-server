<!doctype html>
  ...
  <div class="wrapper">
        ...
        <?php include $_SERVER['DOCUMENT_ROOT']."/".PROJECT."/app/views/includes/navbar.php"?>
              ...
              <div class="container-fluid ">
                    ...
                    <div class="invoi  invoi-blue">
                        <div class="row">
                          <div class="col-sm-12">
                               <h5 class ="text-blanco">Depuración de Clientes</h5>
                            </div>
                        </div>
                    </div>
                          ...
                          <div class="row">
                            <div class="col-sm-12">
                                <div class = "alert alert-info">
                                      En este apartado puede eliminar de la base de datos la información de los clientes, siempre y cuando estos no esten relacionados con algun movimiento, es decir que no tenga ventas, cobranza o saldos asociados.
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-sm-12">
                                <div class = "alert alert-warning">
                                      Este proceso se registrará en una bitácora
                                </div>
                            </div>
                          </div>
                       </div>
                       ...
                       <div class="invoi  invoi-blue">
                           <div class="row">
                             <div class="col-sm-12" style="text-align:center;">
                                         ...
                                         <img src="<?php echo PATH; ?>/img/excel_client.jpg"/>
                                         <br><br><br>
                               </div>
                           </div>
                       </div>
    ...
    <script src ="<?php echo PATH; ?>js/settings/client_debug.js?v=<?php echo(rand()); ?>"></script>
</body>
</html>

<!doctype html>
  ...
  <div class="wrapper">
        ...
        <?php include $_SERVER['DOCUMENT_ROOT']."/".PROJECT."/app/views/includes/navbar.php"?>
              ...
              <div class="container-fluid ">
                    ...
                    <div class="invoi invoi-blue">
                        <div class="row">
                          <div class="col-sm-8">
                               <h5 class ="text-blanco"><i class="fas fa-store"></i> Editar Usuario para Punto de Venta</h5>
                            </div>
                        </div>
                    </div>
                              ...
                              <div class="row">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-12" style ="margin-bottom:20px;">
                                      ...
                                      <div class="col-md-6 col-sm-12 col-12 ">
                                          ...
                                          <div class="form-group row">
                                              <div class="col-sm-12">
                                                  <div class="alert alert-info">Este cambio se verá afectado en <b>Tiendas</b> cuando la información se <b>sincronice</b></div>
                                              </div>
                                          </div>
    ...
    <script src ="<?php echo PATH; ?>js/user/pos_edit.js?v=<?php echo(rand()); ?>"></script>
</body>
</html>

<!doctype html>
  ...
  <div class="wrapper">
        ...
        <?php include $_SERVER['DOCUMENT_ROOT']."/".PROJECT."/app/views/includes/navbar.php"?>
              ...
              <div class="container-fluid ">
                    ...
                    <div class="invoi">
                        <div class="row">
                          <div class="col-sm-12">
                               <h5 class ="text-primary">Editar Permisos de Usuario de Punto de Venta</h5>
                            </div>
                        </div>
                    </div>
    ...
    <script src ="<?php echo PATH; ?>js/user/pos.js?v=<?php echo(rand()); ?>"></script>
</body>
</html>

        ...
        <?php include $_SERVER['DOCUMENT_ROOT']."/".PROJECT."/app/views/includes/navbar.php"?>
              ...
              <div class="container-fluid ">
                    ...
                    <div class="invoi invoi-blue">
                        <div class="row">
                                  <div class="col-sm-8">
                                    <h5 class="text-blanco"><i class="fas fa-users"></i> Usuario del Sistema</h5>
                                  </div>
                                  <div class="col-sm-4">
                                        <a href="../createUserConsole/" class="btn my-btn-blanco btn-sm float-right"><i class="fas fa-user"></i> Nuevo Usuario</a>
                                   </div>
                        </div>
                    </div>
                                                          ...
                                                          <td align = "center">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                    ...
                                                                    <a class="dropdown-item" href="../consolePermission/'.$row->iduser.'/" ><i class="fas fa-user-lock"></i> Permisos</a>
                                                                    <div class="dropdown-divider"></div>
                                                                    <a class="dropdown-item" href="../consoleEdit/'.$row->iduser.'/" ><i class="fas fa-user-edit"></i> Editar</a>
                                                                    <div class="dropdown-divider"></div>
                                                                    <a class="dropdown-item" href="../consoleStore/'.$row->iduser.'/" ><i class="fas fa-store"></i> Asignar Almacenes</a>
                                                                    <div class="dropdown-divider"></div>

...
require_once "../../models/BankTransferModel.php";

switch ($action) {
    case 1:  /* CREAR NUEVA TRANSFERENCIA BANCARIA */
        require("./include/banktransfer/create.php");
    break;
    case 2:  /* LISTAR TRANSFERENCIAS POR SUCURSAL */
        require("./include/banktransfer/list.php");
    break;
    case 3:  /* EDITAR TRANSFERENCIAS */
        require("./include/banktransfer/edit.php");
    break;
    case 4:  /* CONSULTAR TRANSFERENCIA */
        require("./include/banktransfer/one.php");
    break;
    default:

...
$(".btn-save").click(function () {
  ...
  let url = `../../app/api/customer.php?a=8`;
  ...
  fetch(url, { method: 'POST', body: data })
    ...
    .then(function (data) {
      ...
      if (code == 201) {
        showModalMessageError("success", "Cliente Agregado Correctamente", 2300);
    ...
    .catch(function (err) { stop_scrum(); console.log('catch error en fetch', err); });
});

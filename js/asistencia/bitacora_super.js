...
const getList = (page) => {
  ...
  let url = `../../app/api/asistencia.php?a=3&sucursal=${sucursal}&movimiento=${movimiento}&fecha=${fecha}&fechafin=${fechafin}&orden=${orden}`;
  console.log(url);
  fetch(url)
   ...
   .then(function(data) {
     console.log(data);
       if(data.code == 200)
       {
          ...
          $(".r-xls").attr("href", `../../reportExcel/bitacoraAsistenciaSuper/${sucursal}/${movimiento}/${fecha}/${fechafin}/${orden}/`);
       }
       stop_scrum();
   })
